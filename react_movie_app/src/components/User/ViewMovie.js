...
function ViewMovie() {
    ...
    try {
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          modal.innerHTML = `<div class="modal-content" style="position: relative;">
          <h2>Booking Confirmed</h2>
          <p>Your Order ID is: ${bookingId}</p>
          <span class="close" style="display: flex; justify-content: flex-end;">
  ...
  function convertTo12HourFormat(time) {
    ...
    const formattedTime = `${displayHours}:${minutes < 10 ? "0" + minutes : minutes
      } ${period}`;
  ...
  return (
    <>
      <Navbar />
      <div className="container-fluid fullbody my-2 py-1">
        <div className="row">
